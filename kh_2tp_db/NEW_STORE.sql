...
B.BRAND_OPEN, B.BRAND_CLOSE FROM BRAND_TB B WHERE B.BRAND_NAME = '미정국수';

INSERT INTO STORE_TB (STORE_NO, STORE_NAME, STORE_PHONE, STORE_ADDR, STORE_MAP, BRAND_NAME, BRAND_OPEN, BRAND_CLOSE)
SELECT STORE_NO_SEQ.NEXTVAL, '백철판0410 건대역점', '02-499-0410', '서울 광진구 동일로22길 105 지하1층', '37.54093106859639, 127.06984836333254', '백철판',
B.BRAND_OPEN, B.BRAND_CLOSE FROM BRAND_TB B WHERE B.BRAND_NAME = '백철판';
