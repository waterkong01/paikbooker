...
CREATE TABLE RESERVATION_TB (
	...
	r_submit_time VARCHAR2(20) DEFAULT TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
	...
	CONSTRAINT fk_reservation_store
		FOREIGN KEY (store_no, store_name, store_phone)
		REFERENCES STORE_TB (store_no, store_name, store_phone)
		ON DELETE CASCADE,
	--UNIQUE 제약조건
...
--예약_더미 데이터 생성
INSERT INTO RESERVATION_TB (r_no, user_id, user_name, store_no, store_name, store_phone, r_person_cnt, r_time, r_submit_time)
VALUES (R_NO_SEQ.NEXTVAL, 'asdf1234', '두둥탁', '8', '롤링파스타 가로수길점', '02-543-5688', 3, '13:00', TO_DATE('2024-11-28', 'YYYY-MM-DD'));

INSERT INTO RESERVATION_TB (r_no, user_id, user_name, store_no, store_name, store_phone, r_person_cnt, r_time, r_submit_time)
VALUES (R_NO_SEQ.NEXTVAL, 'qwer1234', '둥두둥', '8', '롤링파스타 가로수길점', '02-543-5688', 5, '15:00', TO_DATE('2024-11-28', 'YYYY-MM-DD'));

INSERT INTO RESERVATION_TB (r_no, user_id, user_name, store_no, store_name, store_phone, r_person_cnt, r_time, r_submit_time)
VALUES (R_NO_SEQ.NEXTVAL, 'qwer1234', '둥두둥', '7', '한신포차 중앙대점', '02-817-5238', 5, '23:00', TO_DATE('2024-11-28', 'YYYY-MM-DD'));
