...
제 1 장 총칙
제 1 조 (목적)
이 약관은 백부커(PAIKBOOKER) 서비스(이하 "서비스")의 이용과 관련하여 "회사"와 "회원"(제2조에서 정의합니다) 간의 권리, 의무 및 책임사항, "회원"의 "서비스" 이용 절차에 관한 사항을 규정함을 목적으로 합니다. 이 약관은 "회사"가 제공하는 "서비스" 일체에 적용됩니다.

제 2 조 (용어의 정의)
본 약관에서 사용하는 용어의 정의는 다음과 같습니다.

1. "서비스"란 "회사"가 제공하는 레스토랑에 대한 예약∙대기신청∙정보제공∙추천∙티켓 구매∙상품 구매(이에 한정되지 않음) 등을 위한 온라인 플랫폼 서비스를 의미합니다. 서비스는 구현되는 장치나 단말기(PC, TV, 휴대형 단말기 등의 각종 유무선 장치를 포함하며 이에 한정되지 않음)와 상관 없이 캐치테이블 및 캐치테이블 관련 웹(Web)∙앱(App) 등의 제반 서비스를 의미하며, 회사가 공개한 API를 이용하여 제3자가 개발 또는 구축한 프로그램이나 서비스를 통하여 회원에게 제공되는 경우를 포함합니다
2. "회원"이란 "서비스"에 접속하여 본 약관에 따라 "회사"와 이용계약을 체결하고 "회사"가 제공하는 서비스를 이용하는 고객을 말하며, 회원계정(ID/PW)을 생성하지 않은 일반 고객(일명 비회원 고객)도 포함됩니다.
3. "판매자"이라 함은 "회사"가 제공하는 "서비스"를 이용하여 자신의 상품 등을 판매하는 자를 의미하며, 회사로부터 예약∙대기신청∙판매 대행∙판매 중개, 광고 서비스 등을 제공받는 자를 말합니다
...
제 3 조 (약관의 게시와 개정)
1. 본 약관은 "회원"이 서비스 가입 및 이용시 열람 할 수 있으며, "회사"는 본 약관의 내용을 "회원"이 쉽게 열람할 수 있도록 백부커(PAIKBOOKER) 서비스 홈페이지(이하 "홈페이지") 또는 연결화면을 통하여 게시합니다.
...
3. "회사"는 "약관"을 개정할 경우 개정내용과 적용일자를 명시하여 제5조에 따른 방법으로 적용일자 7일 전부터 적용일자 전일까지 공지합니다. 다만, "이용자"에게 불리하게 개정되는 경우에는 적용일자 30일 전부터 적용일자까지 공지하고, 제5조에 따른 방법으로 별도로 통지합니다.
...
제 5 조 (회원에 대한 통지)
1. "회사"가 "회원"에 대한 통지를 하는 경우 이 약관에 별도 규정이 없는 한 서면(전자문서 또는 전자우편을 포함)에 의하여 "회원"이 "회사"에 제공한 전자우편주소, 전화번호, "백부커"의 알림 기능 기타 전자적 수단 등으로 할 수 있습니다.
2. "회사"는 "회원" 전체에 대하여 통지를 하는 경우 "백부커" 초기화면 또는 게시판에 게시하는 방식으로 공지함으로써 전항의 통지에 갈음할 수 있습니다. 다만, "회원"의 "서비스" 이용에 중대하게 불리한 영향을 주는 사항에 대해서는 전항의 통지를 병행합니다.
...
2) ‘판매자’의 레스토랑 예약 서비스
3) ‘판매자’의 레스토랑 대기 서비스
4) ‘판매자’의 상품(주류 기타 일체의 상품·용역을 포함하며 이하 동일) 구매 서비
5) 기타 "회사"가 추가 개발하거나 다른 회사와의 제휴 계약 등을 통해 "회원"에게 제공하는 일체의 서비스

2. "회사"는 "서비스"를 연중무휴, 1일 24시간 제공함을 원칙으로 합니다.
3. "회사"는 "서비스"의 제공에 필요한 경우 정기점검 혹은 수시점검을 실시할 수 있으며, 점검시간은 공지한 바에 따릅니다. 정기점검시간은 사전에 공지하는 것을 원칙으로 하나 부득이 한 사유가 있는 경우 사후에 공지할 수 있습니다.
...
5. "회원"은 "판매자"의 예약 및 대기, 상품 구매 서비스 등 정책을 충분히 숙지하고 "서비스"를 이용하여야 합니다. "회사"는 통신판매중개자로서 통신판매의 당사자가 아니고, "판매자"가 예약 및 대기, 상품 구매 서비스 등의 정책이나 취소∙환불 정책을 별도로 운영하므로, "회원"은 "서비스" 이용시 반드시 그 내용을 확인해야 합니다. "회원"이 이 내용을 제대로 숙지하지 못해 발생한 피해에 대해서는 "회사"가 책임을 부담하지 않습니다.
6. "회사"가 "판매자"의 의뢰를 받아 통신판매를 중개하는 경우 "회사"는 전자상거래법 제12조부터 제15조, 제17조 및 제18조에 따른 통신판매업자의 책임을 지지 않고, “판매자”가 그 책임을 집니다.
...
4. "회사"는 다음 각 호에 해당하는 경우 "서비스"의 일부 또는 전부의 제공을 일시적으로 중단할 수 있습니다. 이 경우 회사는 "서비스" 이용의 중단 사실을 즉시 공지합니다. 다만, "회사"가 사전에 공지할 수 없는 부득이 한 사유가 있는 경우 사후에 공지할 수 있습니다.
...
6. "회사"가 "서비스" 제공을 종료하고자 할 경우, 서비스를 종료하고자 하는 날로부터 1개월 이전에 공지하겠습니다.
7. "회사"는 본 조항에 따른 서비스의 변경, 중지 및 종료로 발생하는 문제에 대해서 어떠한 책임도 지지 않습니다.

제 10 조 (예약 서비스의 이용)
1. "예약 서비스"는 아래의 약관에 따라 운영됩니다.

1) "회원"이 "판매자"의 예약 정책에 따라 정보 입력 및 대금 결제 시 원칙적으로 예약 확정됨
2) "판매자"의 예약 정책에 따라 (i) 예약이 불가할 수 있고 이 경우 대금은 결제되지 않거나 환불되며, (ii) 대금 결제 없이 예약이 확정될 수도 있음
...
제 11조의 2 (상품 구매 서비스의 이용)
1. "상품 구매 서비스"는 아래의 약관에 따라 운영됩니다.

1) "회원"이 "판매자"의 상품 판매 정책에 따라 정보 입력 및 대금 결제
2) 대금 결제와 동시에 상품 구매가 확정됨

2. 상품 구매와 관련하여 "회원"이 입력한 정보에 문제가 있을 경우, 발생한 책임과 불이익은 전적으로 "회원"이 부담하여야 합니다.
3. “상품 구매 서비스”와 관련하여 “회사”는 통신판매중개자로서 통신판매의 당사자가 아니며, “회원”과 “판매자” 간의 자유로운 상품 거래를 위한 시스템을 제공할 뿐 “회원” 또는 “판매자”를 대리하지 않으며, “회원”과 “판매자” 사이에 성립된 거래와 관련된 책임과 “회원” 및 “판매자”가 제공한 정보에 대한 책임은 해당 “회원”과 “판매자”가 직접 부담합니다.
4. “회원”은 “판매자”와 상품 매매 절차에서 분쟁이 발생하면 분쟁의 해결을 위하여 성실히 임해야 하며, 분쟁해결 과정에서 “회원”의 불성실 등 “회원”의 귀책사유로 “판매자”와 “회사”에 발생한 손해에 대하여는 “회원”이 책임을 부담합니다.
5. “회사”는 “회원”에게 “상품 구매 서비스”가 안전하게 제공될 수 있도록 각종 설비와 자료를 관리하고, 서비스가 제공 목적에 맞게 이용되고 있는지 여부를 확인합니다. 만약 “회원” 또는 “판매자”가 관련 법령 및 본 약관상 서비스 이용 목적을 위반한 것으로 확인되는 경우 “회사”는 그에 대한 소명을 “회원” 또는 “판매자”에게 요청할 수 있고, 주문 취소 등 필요한 조치를 할 수 있습니다.
6. “회원”은 “회사”가 “회원”의 서비스 이용 편의를 위하여 “판매자” 등으로부터 제공받은 상품 상품 관련 정보와 기타 콘텐츠를 캐치테이블을 통하여 제공하는 경우에도 상품의 구매 여부는 “회원” 본인의 판단과 책임으로 결정합니다.
7. “회원”의 상품 구매 서비스 이용 과정에서 발생하는 배송 관련 분쟁의 해결, 청약철회 등에 관한 정보에 관하여는 제7장의 상품 구매 서비스에 관한 특약에 의하는 것으로 하며, 그외 규정하지 아니한 내용에 대하여는 전자상거래법 등 관련 법령에 의합니다.

제 12 조 (구매계약의 성립)
1. "판매자"는 일부 예약에 한하여 "예약금" 제도를 제10조와 같이 운영할 수 있습니다.
...
6. 대금 결제 일체는 "판매자"의 운영 제도를 따르며, "회원"은 "서비스" 이용시 반드시 그 내용을 숙지해야 합니다. "회원"이 이 내용을 제대로 숙지하지 못해 발생한 피해에 대해서는 "회사"가 책임을 부담하지 않습니다.

제 12 조의 2 (자동결제)
1. “회원”은 “회사”가 “서비스”를 통해 제공하는 캐치페이 자동결제(이하 “자동결제”) 또는 “판매자”에 대한 직접결제 중 가능한 방법을 선택하여 결제할 수 있습니다.

2. “자동결제”는 캐치테이블에 미리 자동결제 결제수단을 등록한 “회원”이 매장에서 결제할 금액(이하 “결제액”)을 “판매자”가 캐치테이블 매장용 단말기에 입력하면, 등록한 결제수단으로 결제액이 별도의 인증과정 없이 결제되는 서비스로서, 예약금, 선구매 상품과 구분되는 서비스입니다.

3. “회원”이 “자동결제”를 이용하는 경우 별도의 인증과정 없이 결제를 하는 데 동의한 것으로 봅니다.

4. 자동결제 시점에 “회원”의 신용카드 등 자동결제 결제수단의 유효성, 한도, 시스템 장애 등의 문제로 결제 실패가 발생한 경우 “회사”는 어떠한 책임도 부담하지 아니하며, “회사”는 “회사”가 정한 정책에 따라 “회원”에 대한 별도의 고지 없이 “회원”이 등록한 결제수단으로 재결제 시도를 하거나 하지 않을 수 있고, 해당 결제 건에 대하여 자동결제를 지원하지 않고 “판매자”에 대하여 직접결제하도록 할 수 있습니다. “회사”는 결제 실패가 발생한 “회원”이나 해당 결제수단에 대하여 그 사유가 해소되기 전까지 “자동결제”를 지원하지 않을 수 있습니다.

5. “판매자”의 “결제액” 입력 실수 기타 초과결제⬝중복결제로 발생한 “회원”의 손해, 분쟁은 “회원”의 책임으로 해결하여야 하고, 이에 대하여 “회사”는 어떠한 책임도 부담하지 않습니다. 회원이 “결제액”의 적정성 등에 대한 이의를 제기하거나 환불 요청을 하고자 하는 경우 직접 거래당사자인 “판매자”에게 하여야 합니다.

6. 그 밖에 “자동결제”와 관련한 상세한 정책은 개별 전자지급결제대행업자의 결제서비스 이용약관 및 서비스정책을 따릅니다.
...
4. 포인트 관련 회사의 정책은 회사의 영업정책에 따라 변동될 수 있습니다. 회원에게 불리한 변경인 경우에는 회원에 대해 미리 공지하며 서비스 계속 이용 시 동의한 것으로 간주됩니다.
...
2. "회원"은 "회사"에게 자신이 작성한 게시물을 독점적으로 이용(제3자에 대한 이용허락을 포함하여 이하 동일합니다)할 수 있는 권리를 부여합니다. 이에 따라 "회사"는 회원이 작성한 게시물을 검색노출, 판촉, 홍보 기타의 자료로 무상으로 영구적으로 이용할 수 있으며, 필요한 범위 내에서 게시물의 일부를 수정, 복제 및 편집할 수 있고, "회사"로부터 이용 허락을 받은 자 역시 이용허락의 범위 내에서 같습니다.
...
제 18 조 (회원의 의무)
1. "회원"은 기타 관계 법령, 본 약관의 규정, 이용안내 및 서비스상에 공지한 주의사항, "회사"가 공지하는 사항 등을 준수하여야 하며, 기타 회사의 업무에 방해되는 행위를 하여서는 아니 됩니다.
...
제 7 장 상품 구매 서비스에 관한 특약
제 25 조 (적용 범위)
제7장의 규정은 제11조의2의 “상품 구매 서비스”에 관하여만 적용됩니다.

제 26 조 (분쟁의 해결)
1. "회사"는 상품의 수령과 관련하여 “판매자”, “회원” 등 관련 당사자 사이에 분쟁 등이 발생하는 경우에는 이에 관여하지 않으며 어떠한 책임도 부담하지 아니합니다. 이 경우 해당 분쟁 등은 관련 당사자가 직접 해결해야 합니다. 단, 필요한 범위에서 “회사”가 해당 분쟁 등의 해결을 지원할 수 있습니다.
2. 상품의 배송이 완료된 경우, “회원”은 “회사”에 대하여 상품의 하자, 미수령, 반품 등의 사유로 이의를 제기할 수 없습니다. 구매확정 이후에 발생하는 환불, 교환 기타 “판매자”와 “회원” 간에 발생하는 일체의 문제에 대해서는 “판매자”와 직접 해결하는 것을 원칙으로 합니다.

제 27 조 (청약철회 등)
1. “회원”은 전자상거래법 등 관련 법령에 따라 상품을 공급받거나 상품의 공급이 시작된 날부터 7일 이내에 청약철회를 할 수 있습니다. 다만, “회원”에게 책임이 있는 사유로 상품이 멸실 또는 훼손된 경우 등 전자상거래법 제17조 제2항에 따른 청약철회 제한 사유가 있는 경우에는 청약철회가 제한될 수 있습니다.
2. 제1항의 규정에도 불구하고, “회원”은 상품의 내용이 표시∙광고 내용과 다르거나 계약내용과 다르게 이행된 경우에는 해당 상품을 공급받은 날부터 3개월 이내, 그 사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 청약철회를 할 수 있습니다.
